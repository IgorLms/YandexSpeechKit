...
# Запуск скрипта text_to_audio.py в докере
docker exec yandex_speech_kit python3 yandex_script/text_to_audio.py --export='название_файла' --text='текст_для_аудио'

# Запуск скрипта audio_to_text.py в докере
docker exec yandex_speech_kit python3 yandex_script/audio_to_text.py --audio='название_файла'
```